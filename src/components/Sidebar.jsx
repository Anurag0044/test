  ...
  return (
    <>
      ...
      <div className="sidebar-mobile-bar">
        <div className="sidebar-mobile-brand" onClick={() => navigate('/')}>
          <div className="sidebar-logo-icon">M</div>
          <span className="sidebar-brand">MedIntel</span>
        </div>
        <button
          className={`sidebar-hamburger ${mobileOpen ? 'sidebar-hamburger-active' : ''}`}
